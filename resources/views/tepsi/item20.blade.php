                 ...
                 <div class="row justify-content-center align-items-center">
                          ...
                          <div id="carouselExampleControls" class="carousel slide mb-2" data-ride="carousel" data-interval="false">
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img class="img-fluid m-1 p-1" alt="Third slide" src="{{asset('img/tepsi/laminas/serrucho.png')}}" />
                              ...
                              <div class="carousel-item">
                                <img class="img-fluid m-1 p-1" alt="Third slide" src="{{asset('img/tepsi/laminas/sombrilla.png')}}" />
                                <div data-toggle="tooltip" data-placement="left" title="Anota la respuesta del niño y califícala antes de pasar al siguiente animal">
                              ...
                              <div class="carousel-item">
                                <img class="img-fluid m-1 p-1" alt="Third slide" src="{{asset('img/tepsi/laminas/vela.png')}}" />
                                <div data-toggle="tooltip" data-placement="left" title="Anota la respuesta del niño y califícala antes de pasar al siguiente animal">
                              ...
                              <div class="carousel-item">
                                <img class="img-fluid m-1 p-1" alt="Third slide" src="{{asset('img/tepsi/laminas/zapatos.png')}}" />
                                <div data-toggle="tooltip" data-placement="left" title="Anota la respuesta del niño y califícala antes de pasar al siguiente animal">
                              ...
                              <div class="carousel-item">
                                <img class="img-fluid m-1 p-1" alt="Third slide" src="{{asset('img/tepsi/laminas/escoba.png')}}" />
                                <div data-toggle="tooltip" data-placement="left" title="Anota la respuesta del niño y califícala antes de pasar al siguiente animal">
                              ...
                              <div class="carousel-item">
                                <img class="img-fluid m-1 p-1" alt="Third slide" src="{{asset('img/tepsi/laminas/taza.png')}}" />
                                <div data-toggle="tooltip" data-placement="left" title="Anota la respuesta del niño y califícala antes de pasar al siguiente animal">
                              ...
                              <div class="carousel-item">
                                <img class="img-fluid m-1 p-1" alt="Third slide" src="{{asset('img/tepsi/laminas/reloj.png')}}" />
                                <div data-toggle="tooltip" data-placement="left" title="Anota la respuesta del niño y califícala antes de pasar al siguiente animal">
                              ...
                              <div class="carousel-item">
                                <img class="img-fluid m-1 p-1" alt="Third slide" src="{{asset('img/tepsi/laminas/tetera.png')}}" />
                                <div data-toggle="tooltip" data-placement="left" title="Anota la respuesta del niño y califícala antes de pasar al siguiente animal">
                    ...
                    <div class="col-lg-5 align-self-center">
                        ...
                        <div class="row-fluid rounded-sm border mb-2">
                            <h4>Materiales:</h4> <p class="m-1">Lamina 9</p>
                        </div>
                        ...
                        <div class="row-fluid rounded-sm border mb-2">
                             <h4>Administración:</h4> <p class="m-1">El examinador presenta al niño la Lamina 9 y señalando cada figura dice: <strong class="text-danger">"¿Cómo se llama?"</strong> o <strong class="text-danger">"¿Qué es?"</strong>. No debe dar ninguna ayuda adicional, ni ejemplificar. El examinador debe registrar textualmente cada respuesta del niño.</p>
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="row-fluid rounded-sm border mb-1">
                            <h4>Criterio de aprobación:</h4> <p class="m-1">Si el niño nombra correctamente al menos cinco de los ocho objetos (paraguas, escoba, zapatos o zapatillas, serrucho, vela, tetera, reloj, taza). Se aceptan respuestas que sean verbalizaciones un poco deformadas de las palabras exactas (Ej. "eloc" por reloj". No se aceptan verbalizaciones del tipo "cucú" por reloj.</p>
