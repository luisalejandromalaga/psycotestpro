...
// select the columns
$select = array('id', 'name', 'email', 'password','created_at');
...
$productos = $db->arraybuilder()->paginate("users", $page, $select);
        ...
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
	            <a href="add_product.php?operation=create">
	            	<button class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Descargar Excel</button>
	            </a>
            </div>
        </div>
    </div>
        ...
        <tbody>
            ...
            foreach ($productos as $row) { ?>
                <tr>
	                ...
	                <td><?php echo $row['name'] ?></td><!-- <td><?php echo $row['f_name']." ".$row['l_name'] ?></td>  -->
