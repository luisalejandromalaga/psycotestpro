...
<div class="container">
    ...
    <div class="card mt-3 mb-3">
      <div class="card-header">
        <h4 class="" id="">Nombra características de objetos</h4>
      </div>
                 ...
                 <div class="row justify-content-center align-items-center">
                          ...
                          <div id="carouselExampleControls" class="carousel slide mb-2" data-ride="carousel" data-interval="false">
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <h4>¿Cómo es esta pelota?... ¿Y que más?</h4>
                              ...
                              <div class="carousel-item">
                                <h4>¿Cómo es este globo?... ¿Y que más?</h4>
                                <div data-toggle="tooltip" data-placement="bottom" title="Anota la respuesta del niño y califícala antes de pasar a la siguiente pregunta">
                              ...
                              <div class="carousel-item">
                                <h4>¿Cómo es esta bolsa?... ¿Y que más?</h4>
                                <div data-toggle="tooltip" data-placement="bottom" title="Anota la respuesta del niño y califícala antes de pasar a la siguiente pregunta">
                    ...
                    <div class="col-lg-5 align-self-center">
                        ...
                        <div class="row-fluid rounded-sm border mb-2">
                            <h4>Materiales:</h4> <p class="m-1">Pelota, Globo inflado, bolsa con arena</p>
                        </div>
                        ...
                        <div class="row-fluid rounded-sm border mb-2">
                             <h4>Administración:</h4> <p class="m-1">El examinador le pasa la pelota al niño en su mano y le pregunta: <strong class="text-danger"> "¿Cómo es esta pelota?"</strong> Si el niño da alguna característica se le pregunta: <strong class="text-danger">"¿Y que más?"</strong> a fin de obtener más respuestas sobre el objeto. Luego se le pasa el globo y posteriormente la bolsa repitiendo las preguntas: <strong class="text-danger">"¿Como es este(a)?" (globo, bolsa) "¿Y que más?"</strong>. El examinador no debe dar ningún tipo de ayuda o ejemplo al niño, ni cambiar la formulación de la pregunta. Debe anotar textualmente cada respuesta.</p>
                ...
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="row-fluid rounded-sm border mb-1">
                            <h4>Criterio de aprobación:</h4> <p class="m-1">Si el niño nombra dos o más características de al menos 2 objetos que hagan referencia a su tamaño, forma, textura, color. Ejemplo: Bolsa: pesada, larga, dura, (tamaño), (color). Pelota: chica, redonda, amarilla, peluda… Globo: grande, redondo, suave, (color), se infla, se agranda, se estira.</p>
