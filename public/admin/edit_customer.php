...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
    ...
    if( $_FILES['url_image']['name'] != ''){
        ...
        $data_to_update['url_image'] = $_FILES['url_image']['name'];
        $name_array = $_FILES['url_image']['name'];
        $tmp_name_array = $_FILES['url_image']['tmp_name'];
    ...
    if($stat)
    {
        $_SESSION['success'] = "Producto updated successfully!";
